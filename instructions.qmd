...
table_df["Relative Change"] = (
  table_df["Relative Change"].round(0).astype(str) + "%" 
)
```
...
emissions_long_1990_2022 = emissions_long.query("year >= 1990 and year <= 2022").copy()
...
fig_chart = px.line(
    ...
    labels={"year": "Year", "emissions": "CO2 Emissions", "name": "Country"},
)
